...
export function TutorialVideoModal({ purchaseUrl }: { purchaseUrl: string }) {
  ...
  return (
    <div
      className="fixed inset-0 z-[100] flex items-center justify-center bg-black/65 p-3 backdrop-blur-[2px] sm:p-4"
      role="dialog"
      aria-modal="true"
      aria-labelledby="usage-warning-title"
    >
      <div className="max-h-[calc(100vh-1.5rem)] w-full max-w-[22rem] overflow-y-auto rounded-[28px] bg-white shadow-[0_25px_80px_rgba(15,23,42,0.35)] sm:max-h-[calc(100vh-2rem)] sm:max-w-md sm:rounded-[32px]">
        <div className="px-5 pb-4 pt-5 text-center sm:px-8 sm:pb-6 sm:pt-7">
          ...
          <div className="mt-5 overflow-hidden rounded-[20px] bg-[#0b0b0f] px-3 py-4 text-white sm:mt-6 sm:rounded-[22px] sm:px-4 sm:py-5">
