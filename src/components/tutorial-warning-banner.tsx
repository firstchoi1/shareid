...
export function TutorialWarningBanner() {
  ...
  return (
    <>
      <div style={{ height: bannerHeight > 0 ? bannerHeight + 12 : undefined }} aria-hidden />
      <section
        ref={bannerRef}
        className="fixed left-1/2 top-3 z-40 w-[calc(100%-1.5rem)] max-w-3xl -translate-x-1/2 overflow-hidden rounded-xl border border-cyan-200/80 bg-gradient-to-br from-sky-300 via-cyan-300 to-teal-300 shadow-[0_10px_30px_rgba(14,116,144,0.28)] ring-1 ring-cyan-200/80"
      >
